...
new Vue({
  ...
  computed: {
    personasFiltradas: function personasFiltradas() {
      ...
      return this.personas.filter(function (p) {
        return p.nombre.toLowerCase().indexOf(_this.filtro) >= 0 || p.apellido.toLowerCase().indexOf(_this.filtro) >= 0 || p.edad.toLowerCase().indexOf(_this.filtro) >= 0 || p.sexo.toLowerCase().indexOf(_this.filtro) >= 0;
      });
    },
  ...
  methods: {
    ...
    traerContactos: function traerContactos() {
      var agendaCompleta = localStorage.getItem('personas');
      if (agendaCompleta) {
        this.personas = JSON.parse(agendaCompleta);
      }
    },
    agregarContactoLocalStorage: function agregarContactoLocalStorage() {
