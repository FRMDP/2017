...
<style>
	* {
	...
	.moon {
	  ...
	  border-radius: 90px;
	  background: -moz-linear-gradient(-45deg, #ffffff 0%, rgba(255, 255, 255, 0.99) 1%, rgba(255, 255, 255, 0) 70%);
	  ...
	  background: -o-linear-gradient(-45deg, #ffffff 0%, rgba(255, 255, 255, 0.99) 1%, rgba(255, 255, 255, 0) 70%);
	  background: -ms-linear-gradient(-45deg, #ffffff 0%, rgba(255, 255, 255, 0.99) 1%, rgba(255, 255, 255, 0) 70%);
	...
	.mountain-first:after {
	  ...
	  width: 100%;
	  height: 60%;
	  background: -moz-linear-gradient(top, rgba(125, 185, 232, 0) 0%, #0092ff 65%);
	  ...
	  background: -o-linear-gradient(top, rgba(125, 185, 232, 0) 0%, #0092ff 65%);
	  background: -ms-linear-gradient(top, rgba(125, 185, 232, 0) 0%, #0092ff 65%);
