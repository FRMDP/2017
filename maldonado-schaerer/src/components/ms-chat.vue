	...
	<!-- NAME SELECTION -->
		<b-row align-h="center" v-if="!chatName">
			<b-col cols="6" md="4" lg="4" align-self="center">
				...
				<input v-model="nameInput" type="text" class="form-control" 
					...
					placeholder="Set your galaxy name:" @keyup.enter="setChatName">
				<button :disabled="!nameInputComputed" @click="setChatName" id="doneNameButton" 
		...
		<div v-else>
			<div v-if="!side">
				...
				<b-row align-h="center" class="chooseMobileDemo">
					<section class="the-demo" style="align-self:center;">
						<div class="example-item mobilexample-item">
							...
							<h3 class="sideName mobileSideName">Yoda</h3>
						</div>
						<div class="example-item mobilexample-item">
							<div class="lightsaber mobileLightSaber">
							...
							<h3 class="sideName mobileSideName">Vader</h3>
						</div>
						<div class="example-item mobilexample-item">
							<div class="lightsaber mobileLightSaber">
							...
							<h3 class="sideName mobileSideName">Windu</h3>
						</div>
						<div class="example-item mobilexample-item clearfix">
							...
							<h3 class="sideName mobileSideName">Obi</h3>
						</div>
					</section>
				</b-row>
			</div>
			...
			<div v-else style="padding-left: 10px;padding-right: 10px;">
				<div>
					...
					<b-container>
						<b-row style="margin-bottom: 20px;">
							<!-- YOUR NAME --> 
							<b-col cols="5">
								<button class="btn btn-outline-primary btn-block" @click="openNameInput">
									Be unrecognizable
								</button>
							</b-col>
							<!-- YOUR SIDE -->
							<b-col cols="5">
								<button class="btn btn-outline-danger btn-block" @click="openChoseSide">
								Betray your brothers
							</button>
							</b-col>
						</b-row>
					</b-container>
					<b-row style="margin-bottom: 20px;" align-h="center" v-if="isNameInputOpen">
						<b-col cols="6" md="4" lg="4" align-self="center">
							...
							<input v-model="nameInput" type="text" class="form-control" 
								...
								placeholder="Set your galaxy name:" @keyup.enter="changeChatName">
							<button :disabled="!nameInputComputed" @click="changeChatName"id="doneNameButton" 
								class="btn btn-primary forceBtn mobileForceBtn">
								The force is with me
							</button>
						</b-col>
					</b-row>
					<b-row align-h="center" style="margin-bottom: 20px;" v-if="isChangeSideOpen">
						<b-col cols="6" align-self="center">
							<h1 class="sideTitle mobileSideTitle">Choose your new side</h1>
						</b-col>
						<section class="the-demo changeMobileDemo">
							<div class="example-item mobilexample-item">
								<div class="lightsaber mobileLightSaber">
					...
					<div class="chatMessages">
						<div v-for="messageChat in messages">
							...
							<div v-else-if="messageChat.transmitter == chatName" class="ownMessage mobileMessages">
				...
				<div class="sendText">
					<button class="btn btn-primary sendBtn" :disabled="!messageComputed" @click="sendMessage">Send</button>
					<div class="group">      
				      	<input class="messageInput" v-model="message" @keyup.enter="sendMessage"
				      		style="color:white;"
...
<script>
	...
	export default{
		...
		methods: {
			chooseSide(decision){
				setTimeout(() => {
					this.$store.commit('chooseSide', decision);
				}, 1000);
				this.$chatStorageService.setSide(decision);
			},
			setChatName(){
				if(this.nameInput){
			...
			changeChatName(){
				...
				const msg = 
					{ transmitter: "system", 
					  content: "The user " + this.chatName + " is now called " + this.nameInput + "."
					};
				this.socket.emit('sendMessage', msg);
				this.setChatName();
