...
var _zpAlert = __webpack_require__(7);
...
exports.default = new _vueRouter2.default({
	routes: [{ path: '/', component: _zpPortada2.default, name: 'index' }, { path: '/search', component: _zpSearch2.default, name: 'search' }, { path: '/result/:name', component: _zpResult2.default, name: 'result', beforeEnter: function beforeEnter(to, from, next) {
			console.log('to', to);
			console.log('from', from);
			console.log('next', next);
		} }, { path: '/lyrics/:id/:name', component: _zpLyric2.default, name: 'lyric' }]
});
...
exports.default = {
    ...
    data: function data() {
        return {
            radio: '',
            search: '',
            str: ['nameArtist', 'nameTrack', 'country']
        };
    },
    ...
    methods: {
        send: function send() {
            ...
            this.$router.push({ name: 'result', params: { name: string } });
            this.$store.commit('putTypeSearch', this.str[this.radio]);
        }
    },
    watch: {}
      ...
      [
        _c(
          "md-radio",
          {
            ...
            attrs: { id: "my-test4", name: "my-test-group2", "md-value": "0" },
            model: {
              value: _vm.radio,
              callback: function($$v) {
                _vm.radio = $$v
        ...
        _c(
          ...
          {
            staticClass: "md-primary",
            attrs: { id: "my-test5", name: "my-test-group2", "md-value": "1" },
            model: {
              value: _vm.radio,
              callback: function($$v) {
                _vm.radio = $$v
        ...
        _c(
          ...
          {
            staticClass: "md-primary",
            attrs: { id: "my-test6", name: "my-test-group2", "md-value": "2" },
            model: {
              value: _vm.radio,
              callback: function($$v) {
                _vm.radio = $$v
              ...
              _c(
                ...
                [
                  ...
                  _vm.radio == 1
                    ...
                    : _vm._e(),
                  _vm._v(" "),
                  _vm.radio == 2 ? _c("label", [_vm._v("País")]) : _vm._e(),
                  _vm._v(" "),
                  _c("md-input", {
                    model: {
                      value: _vm.search,
    ...
    methods: {
        getArtist: function getArtist() {
            ...
            this.$http.get(st + '&page_size=1').then(function (response) {
                ...
                var prms = [];
                for (var i = 1; i <= paginas; i++) {
                    var st1 = _this2.$apiRoutes.getRoutes('trackSearch', { name: 'nameArtist', value: _this2.name }, { name: 'page', value: i }, { name: 'pageSize', value: 50 });
                    prms.push(_this2.$http.get(st1));
                }
                Promise.all(prms).then(function (values) {
                    values.forEach(function (list) {
                        var array = list.data.message.body.track_list;
                        array.forEach(function (t) {
                            ...
                            if (tr.has_lyrics == 1) {
                                ...
                                _this2.songs.push(Object.assign({}, ob));
                            }
                        });
                    });
                }).catch(function (msg) {
  ...
  return _c(
    ...
    [
      ...
      _vm.pbar
        ? _c(
            ...
            [
              ...
              _vm._v(" "),
              _c("h3", [_vm._v("Aguarde mientras se carga la página...")])
            ],
            1
          )
        : _c(
      ...
      _c("div", { staticStyle: { "padding-left": "100px" } }, [
        _vm._v("Resultados: " + _vm._s(_vm.trackFilter.length) + " ")
      ]),
      _vm._v(" "),
      _vm.shown
        ? _c(
...
var methods = [{
    ...
    parameters: [{ country: '&country=' }, { page: '&page=' }, { pageSize: '&page_size=' }, { hasLirics: '&f_has_lyrics=' //[1]
    }]
}, {
    name: 'trackSearch',
