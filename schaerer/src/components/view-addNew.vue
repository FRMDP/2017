			...
			<!-- FORMULARIO AGREGAR CONTACTO  -->
				<form>
					...
					<div class="row">
						...
						<div class="col s12 m6 l6">
							<select v-model="news.category.id" style="display: block;">
				  	...
				  	<div class="row">
						...
						<div class="col s12 m6 l6">
							<select v-model="news.reporter.id" style="display: block;">
								<option v-for="reporter in reporters" v-bind:value ="reporter.id">{{reporter.name}}</option>
							</select>
				  	  	</div>
				  	</div>
					<div class="row">
